...
const handlePayment = () => {
 ...
 const categories = [
  ...
  const ServiceIcon = ({ name, iconLibrary = 'MaterialIcons', size = 24, color = '#4CAF50' }) => {
    const IconComponent = iconLibrary === 'MaterialIcons' ? Icon : Ionicons;
  ...
  contentContainerStyle={{ paddingBottom: 100 }} // Adjust height if needed
        ...
        <View style={styles.section}>
          ...
          >
            ...
            <View style={styles.radioContent}>
              ...
              <Text style={styles.radioSubText}>This contains attendent</Text>
