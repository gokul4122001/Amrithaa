...
const styles = StyleSheet.create({
  ...
  greeting: { fontSize: hp('2%'), color: 'black' },
  ...
  noteSection: { marginTop: 12, marginBottom: 20 },
  noteTitle: { fontSize: 18, fontWeight: '600', color: '#333', textAlign: 'center' },
  ...
  ambulanceIcon: { width: 24, height: 24, marginRight: 12 },
  transferTextContainer: { flex: 1 },
  transferText: { fontSize: 16, fontWeight: '500', color: '#333' },
  ...
  minutesText: { color: '#fff', fontWeight: '600' },
  optionInfo: { flex: 1 },
  optionType: { fontSize: 16, fontWeight: '600', color: '#333' },
  optionDescription: { fontSize: 12, color: '#666' },
  optionTime: { fontSize: 12, color: '#666', marginTop: 2 },
  optionPrice: { fontSize: 16, fontWeight: '600', color: '#333' },
  includesSection: { borderTopWidth: 1, borderTopColor: '#eee', paddingTop: 8 },
  includesTitle: { fontWeight: '600', fontSize: 14, color: '#333' },
